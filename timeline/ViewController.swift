...
class ViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        // let detailViewController = self.mainStoryboard?.instantiateViewController(withIdentifier: "ArtistViewController") as! ArtistViewController
        // detailViewController.setArtist(self.searchActive ? self.filteredArtists[indexPath.row] : self.artists[indexPath.row])
